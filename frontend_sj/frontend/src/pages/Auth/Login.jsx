      ...
      <div className="hidden lg:flex lg:w-5/12 xl:w-[440px] flex-col justify-between flex-shrink-0 border-r border-slate-100 dark:border-zinc-800 bg-gradient-to-b from-brand-500/5 via-white to-white dark:from-brand-500/8 dark:via-zinc-900 dark:to-zinc-900 p-12">
        ...
        <div className="flex flex-col items-center text-center gap-7">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 dark:text-zinc-500 mt-3">
        ...
        {/* Bottom */}
        <p className="text-xs text-center text-slate-300 dark:text-zinc-600">© {new Date().getFullYear()} San Jose Municipal Hall</p>
      </div>
        ...
        <div className="w-full max-w-sm animate-fade-slide">
          ...
          <div className="flex flex-col items-center text-center gap-3 mb-8 lg:hidden">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 dark:text-zinc-500 mt-0.5">Batangas · Philippines</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="flex flex-col gap-1.5 mb-4">
              <label htmlFor="identifier" className="text-sm font-medium text-slate-700 dark:text-zinc-300">
                Username
              </label>
              <input
                id="identifier"
