...
function Header() {
  ...
  return (
    <header className="h-[60px] bg-white dark:bg-zinc-950 border-b border-slate-200 dark:border-zinc-800 px-6 flex items-center justify-between flex-shrink-0">
      <div>
      ...
      <div className="flex items-center gap-2">
        <div className="text-right hidden sm:block mr-1">
          <p className="text-sm font-medium text-slate-700 dark:text-zinc-200 leading-tight">{name}</p>
          <p className="text-xs text-slate-400 dark:text-zinc-500 leading-tight mt-px">System Administrator</p>
        </div>
